...
(function () {
    ...
    u = !1;
    if ("undefined" == typeof jQuery) u = !0; else if (m = jQuery.fn.jquery.split("."), 1 > m[0] || 1 == m[0] && 6 > m[1]) u = !0;
    if (u) {
...
function loadHtml5Gallery(u) {
    ...
    var t = m.event, x = t.special, k = null, k = x.drag = {
        defaults: {
            which: 1, distance: 0, not: ":input", handle: null, relative: !1,
            drop: !0, click: !1
            ...
            var e = b.data, a;
            if (!(0 < e.which && b.which != e.which) && !m(b.target).is(e.not) && (!e.handle || m(b.target).closest(e.handle, b.currentTarget).length)) if (e.propagates = 1, e.interactions = [k.interaction(this, e)], e.target = b.target, e.pageX = b.pageX, e.pageY =
            ...
            if (a) {
                ...
                a.results = [];
                do if ((w = a.interactions[g]) && !("dragend" !== e && w.cancelled)) q = k.properties(b, a, w), w.results = [], m(d || w[j] || a.droppable).each(function (c, d) {
                    q.target = d;
    ...
    n.fn.addHTML5VideoControls = function (b, e, a, c, d, h, f, j, l) {
        var g = "ontouchstart" in window, w = g ? "touchstart" : "mousedown", q = g ? "touchmove" : "mousemove",
            k = g ? "touchcancel" : "mouseup", m = g ? 48 : 36, t = null, u = null, s = !1, x = !0,
            D = n(this).data("ishd"), A = n(this).data("hd"), F = n(this).data("src"), r = n(this);
        ...
        var U = n(".html5boxTimeCurrent",
            v), G = n(".html5boxTimeTotal", v), C = n(".html5boxSeeker", v), O = n(".html5boxSeekerPlay", v),
            P = n(".html5boxSeekerBuffer", v), M = n(".html5boxSeekerHandler", v);
        U.css({
            display: "block",
            position: "relative",
            "float": "left",
            ...
            var H = function (a) {
                f ? a ? (r.get(0).setAttribute("controls", "controls"), j && r.get(0).setAttribute("controlsList", "nodownload")) : r.get(0).removeAttribute("controls") :
                    a ? (n(document).on("mousemove", J), v.css({
                        ...
                        "z-index": 2147483647,
                        display: "block"
                    }), B.css({"z-index": 2147483647})) : (n(document).off("mousemove", J), v.css({
                        "z-index": "",
                        position: "absolute"
                    }), E.css({"z-index": "", display: "none"}), B.css({"z-index": ""}))
            };
        ...
        if (r.get(0).volume === a / 2 + 0.1) {
            ...
            var V = n(".html5boxVolumeButton", v), Z = n(".html5boxVolumeBar", v), K = n(".html5boxVolumeBarBg", v),
                Q = n(".html5boxVolumeBarActive", v);
            h.css({
                display: "block",
                position: "relative", "float": "right", width: "32px", height: "32px", margin: Math.floor((m - 32) / 2)
            }).hover(function () {
                clearTimeout(u);
            ...
            Q.css({
                ...
                width: "100%", height: "100%", "background-color": "#fcc500"
            });
            K.on(w, function (a) {
    ...
    b.fn.html5gallery = function (k) {
        ...
        e.prototype = {
            getParams: function () {
                ...
                if (this.options.showsocial) {
                    ...
                    b(".html5gallery-social-btn-" + this.id).click(function () {
                        var a = window.location.href + (0 > window.location.href.indexOf("?") ? "?" : "&") + "galleryshareid=" + c.elemArray[c.curElem][0],
                            d = c.elemArray[c.curElem][7], h = c.absoluteUrl(c.elemArray[c.curElem][2]),
                ...
                (b("img.html5galleryimg", this.container).length ? b("img.html5galleryimg", this.container) : b("img", this.container)).each(function () {
                    ...
                    for (var d = a.options.lazyloadtags.split(","), e = 0; e < d.length; e++) if (b(this).data(d[e]) && 0 < b(this).data(d[e]).length) {
                        c = b(this).data(d[e]);
                        break
                    }
                    var d = c, e = b(this).data("title") ? b(this).data("title") : b(this).attr("alt"),
                    ...
                    f || (f = "");
                    j || (j = "");
                    var l = a.options.width, g = a.options.height, w = b(this).data("duration") ?
                        b(this).data("duration") : 0, q = null, k = null, m = null, n = null, s = null, t = null,
                        u = null, x = null, A = null, F = null, r = null, B = null, E = null, v = !1;
            ...
            processElemArray: function (a) {
                ...
                for (d = 0; d < a.elemArray.length; d++) if (13 == a.elemArray[d][9] && a.elemArray[d][19] && a.elemArray[d][20]) {
                    b = !0;
                    break
                }
            ...
            createSocialMedia: function () {
                ...
                this.isFullscreen ? (a = Math.max(0, Math.floor(b(".html5gallery-fullscreen-elem-wrapper-" + this.id, this.$fullscreen).width() * a)), b(".html5gallery-fullscreen-timer-" + this.id, this.$fullscreen).css({width: a + "px"})) : (a = Math.max(0, Math.floor(b(".html5gallery-elem-" +
                    this.id, this.$gallery).width() * a)), b(".html5gallery-timer-" + this.id, this.$gallery).css({width: a + "px"}))
                ...
                "ontouchstart" in window && ("vertical" == this.options.skin || "verticallight" == this.options.skin || "showcase" == this.options.skin ? b(".html5gallery-car-" +
                    ...
                    preventWebBrowser: !0, swipeTop: function () {
                        b(".html5gallery-car-right-" + a.id, a.$gallery).click()
                    }, swipeBottom: function () {
                        b(".html5gallery-car-left-" + a.id, a.$gallery).click()
                    }, instance: a, preventWebBrowserCallback: "verticalPreventWebBrowserCallback"
                ...
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    if (1 == a || this.showingPoster) {
                        ...
                        var d = this.isFullscreen ? a : this.options.width,
                            c = this.isFullscreen ? e : this.options.height, f = Math.round(d / 2 - a / 2),
            ...
            createStyleVertical: function () {
                ...
                this.options.responsive ? (this.options.originalWidth = this.options.width, this.options.originalHeight = this.options.height, this.container.css({"max-width": "100%"})) : this.container.css({
                ...
                if ("center" != this.options.imagetoolboxstyle) {
                    var a = Math.round(("bottom" == this.options.headerpos || "bottomoutside" == this.options.headerpos ? 0 : this.options.headerHeight) + this.options.height / 2 - 24),
                        c = a + Math.round(this.options.height / 2) - 32, d = this.options.boxWidth - 48,
                ...
                if ("never" != this.options.showimagetoolbox) {
                    ...
                    if ("center" == this.options.imagetoolboxstyle) a = " .html5gallery-toolbox-" + this.id + " {display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; overflow:hidden; position:relative; margin:0px auto; text-align:center; height:40px;}",
                        ...
                        Math.round(4) + "px; background:url('" + this.options.skinfolder + "next.png') no-repeat top left; } ", a += " .html5gallery-lightbox-" + this.id + " {position:relative; float:left; display:" + ("show" == this.options.imagetoolboxmode ? "block" : "none") + "; cursor:pointer; overflow:hidden; width:32px; height:32px; margin-left:2px; margin-right:2px; margin-top:" + Math.round(4) + "px; background:url('" + this.options.skinfolder + "lightbox.png') no-repeat top left; } "; else {
                        var c = Math.round(("bottom" == this.options.headerpos ? 0 :
                            this.options.headerHeight) + this.options.height / 2 - 24),
                            d = c + Math.round(this.options.height / 2) - 32, e = this.options.width - 54,
                ...
                if (this.container.parent() && this.container.parent().width()) {
                    ...
                    if (1 == a || this.showingPoster) {
                        ...
                        if (this.isFullscreen) var a = this.elemArray[this.curElem][17] ? Math.min(this.elemArray[this.curElem][17], this.fullscreenWidth) : this.fullscreenWidth,
                            ...
                            a = Math.min(a / c, e / d), a = 1 < a ? 1 : a; else a = "fill" == this.options.resizemode ?
                            Math.max(this.options.width / c, this.options.height / d) : Math.min(this.options.width / c, this.options.height / d);
                        var f = Math.round(a * c), j = Math.round(a * d),
                            e = this.isFullscreen ? f : this.options.width,
                            a = this.isFullscreen ? j : this.options.height, c = Math.round(e / 2 - f / 2),
                        ...
                        b(".html5gallery-elem-image-" + this.id).css({
                            width: f +
                                "px", height: j + "px", top: d + "px", left: c + "px"
                        })
                    ...
                    b(".html5gallery-title-" + this.id).css({top: a + "px"});
                    b(".html5gallery-viral-" + this.id).css({top: e + "px"});
                    b(".html5gallery-timer-" + this.id).css({top: String(this.options.elemTop + this.options.height - 2) + "px"});
                    if (this.options.showcarousel) {
                        ...
                        this.options.carouselmultirows ? ("samecolumn" == this.options.thumbresponsive ? b(".html5gallery-thumbs-" + this.id).css({
                        ...
                        }), b(".html5gallery-tn-title-" + this.id).css({width: String(this.options.thumbwidth - 2) + "px"}), b(".html5gallery-tn-title-" + this.id).css({height: this.options.thumbtitleheight + "px"})) : (this.options.thumbShowNum = Math.floor((this.options.width - 4 - 4 - a) / (this.options.thumbwidth +
                            ...
                            this.id).css({height: this.options.thumbtitleheight + "px"}), b(".html5gallery-tn-" + this.id).css({
                            width: this.options.thumbwidth + "px",
                            height: this.options.thumbheight + "px"
                        }), b(".html5gallery-tn-selected-" + this.id).css({
                            width: this.options.thumbwidth + "px",
                ...
                this.options.thumbTotalWidth && (c = this.options.thumbMaskWidth / 2 - this.options.thumbTotalWidth / 2 - this.options.thumbgap / 2), a += ".html5gallery-thumbs-" + this.id + " { position:relative; display:block; margin-left:" + c + "px; width:" + String(this.elemArray.length * (this.options.thumbwidth + this.options.thumbgap)) + "px; top:" + Math.round(this.options.carouselHeight / 2 - this.options.thumbheight / 2) + "px; }", c = Math.round((this.options.width - 4 - 4) / 2 - this.options.thumbMaskWidth / 2), a += " .html5gallery-car-mask-" + this.id + " { position:absolute; display:block; text-align:left; overflow:hidden; left:" +
                    ...
                    function (a, c) {
                        ...
                        if (this.options.thumbShowNum >= this.elemArray.length) b(".html5gallery-car-left-" + this.id, this.$gallery).css({
                            ...
                            d = -d;
                            c ? b(".html5gallery-thumbs-" + this.id, this.$gallery).css({marginLeft: d}) :
                                b(".html5gallery-thumbs-" + this.id, this.$gallery).animate({marginLeft: d}, 500);
                ...
                var a =
                    this, c = b(".html5gallery-thumbs-" + this.id, this.$gallery);
                c.empty();
                for (var d = 0; d < this.elemArray.length; d++) {
                    ...
                    b(e).on("load", function () {
                        ...
                        var d = Math.max(a.options.thumbimagewidth / this.width, a.options.thumbimageheight / this.height),
                            e = Math.round(d * this.width), d = Math.round(d * this.height),
                ...
                b(window).scroll(function () {
                    if (!g.options.isMobile || g.options.mobileresizeevent) {
                        var a = b(".html5gallery-fullscreen-box-" + g.id, g.$fullscreen), c = b(window).height(),
            ...
            enableUpdateCarousel: function () {
                ...
                if (!(0 > a)) {
                    ...
                    !this.options.donotuseposter && (5 == a || 6 == a || 7 == a || 8 == a || 9 == a || 10 == a || 11 == a) && !d && this.elemArray[this.curElem][12] ? (this.showingPoster =
                        !0, this.showPoster()) : (b(".html5gallery-video-play-" + this.id, l).length && b(".html5gallery-video-play-" + this.id, l).remove(), 1 == a ? this.showImage() : (this.options.hidetitlewhenvideoisplaying && b(".html5gallery-title-" + this.id, l).hide(), 5 == a || 6 == a || 7 == a || 8 == a ? this.showVideo(d, e) : 9 == a ? this.showYoutube(d) : 10 == a ? this.showVimeo(d) : 11 == a ? this.showEmbedVideo(d) : 2 == a ? this.showSWF() : 12 == a && this.showIframe()));
                    this.checkMK();
                ...
                b(d).on("load", function () {
                    ...
                    var j = c.isFullscreen ? e : c.options.width, l = c.isFullscreen ? d : c.options.height,
                        g = Math.round(j / 2 - e / 2), k = Math.round(l / 2 - d / 2);
                ...
                d ? (b(".html5gallery-fullscreen-box-" + this.id, this.$fullscreen).css({
                    ...
                    width: a + 2 *
                        this.fullscreenMargin, height: c + 2 * this.fullscreenMargin
            ...
            stopAllPlaying: function () {
                ...
                if ("undefined" !== typeof html5GalleryObjects && html5GalleryObjects && html5GalleryObjects.objects) for (var a = 0; a < html5GalleryObjects.objects.length; a++) if (html5GalleryObjects.objects[a].id != this.id) try {
                ...
                var d = this.isFullscreen ? this.$fullscreen : this.$gallery, e = this.elemArray[this.curElem][10],
                ...
                var a = this.isFullscreen ?
                    this.$fullscreen : this.$gallery, c = this.elemArray[this.curElem][10],
                ...
                this.isVideoPlaying = !0;
                a && this.options.autoslideandplayafterfirstplayed && (this.options.autoplayvideo = !0, this.isPaused = !1);
                var c = this.isFullscreen ? this.$fullscreen : this.$gallery, d = this.elemArray[this.curElem][10],
                ...
                !this.options.isMobile && !this.options.isIE6 && !this.options.isIE7 && !j ? (c = this.elemArray[this.curElem][2].match(/(\?v=|\/\d\/|\/embed\/|\/v\/|\.be\/)([a-zA-Z0-9\-\_]+)/)[2], f = function () {
                }, a && (f = function (a) {
                    a.target.playVideo()
                    ...
                    {
                        width: e, height: d, videoId: c, playerVars: j, events: {
                ...
                var d = this.isFullscreen ? this.$fullscreen : this.$gallery,
                    e = this.elemArray[this.curElem][10], f = this.elemArray[this.curElem][11];
                if (this.isFullscreen) {
                ...
                var a = this.isFullscreen ? this.$fullscreen : this.$gallery, c = this.elemArray[this.curElem][10],
                    d = this.elemArray[this.curElem][11];
                if (this.isFullscreen) {
            ...
            onThumbOver: function (a) {
                ...
                this.elemArray[this.curElem][5] && (b("video", a).css({cursor: "pointer"}), b("video", a).off("click").on("click",
                    function () {
        ...
        this.each(function () {
            ...
            if ((!b(this).data("donotinit") || k && k.forceinit) && !b(this).data("inited")) {
                ...
                h = b(window).width();
                if (this.options.screenquery) for (c in this.options.screenquery) h <= this.options.screenquery[c].screenwidth && (this.options.screenquery[c].gallerywidth && (this.options.width = this.options.screenquery[c].gallerywidth), this.options.screenquery[c].galleryheight && (this.options.height =
...
function HTML5GallerySWFObjectFunc() {
    ...
    function m(a) {
        if (typeof w.addEventListener != f) w.addEventListener("load", a, !1); else if (typeof q.addEventListener != f) q.addEventListener("load", a, !1); else if (typeof w.attachEvent != f) {
            var b = w;
    ...
    function t() {
        ...
        if (0 < b) for (var c = 0; c < b; c++) {
            ...
            if (0 < p.pv[0]) {
                var l = e(g);
                if (l) if (a(z[c].swfVersion) && !(p.wk && 312 > p.wk)) d(g, !0), j && (h.success = !0, h.ref = x(g), j(h)); else if (z[c].expressInstall && k()) {
                    h = {};
    ...
    function b(a) {
        ...
        if (p.win && p.ie) b.innerHTML = a.innerHTML; else if (a = a.getElementsByTagName(j)[0]) if (a = a.childNodes) for (var c = a.length, d = 0; d < c; d++) !(1 == a[d].nodeType && "PARAM" == a[d].nodeName) && 8 != a[d].nodeType && b.appendChild(a[d].cloneNode(!0));
        return b
    }
    ...
    function F(a, b, c) {
        ...
        if (g) if (typeof a.id == f && (a.id = c), p.ie && p.win) {
            var h =
                "", k;
    ...
    var f = "undefined", j = "object", l = "application/x-shockwave-flash", g = "SWFObjectExprInst", w = window,
        q = document, I = navigator, $ = !1, R = [function () {
            if ($) {
        ...
        }], z = [], S = [], N = [], D, T, X, r, B = !1, E = !1, v, J, L = !0, p,
        U = typeof q.getElementById != f && typeof q.getElementsByTagName != f && typeof q.createElement != f,
        G = I.userAgent.toLowerCase(), C = I.platform.toLowerCase(), O = C ? /win/.test(C) : /win/.test(G),
        C = C ? /mac/.test(C) : /mac/.test(G),
        G = /webkit/.test(G) ? parseFloat(G.replace(/^.*webkit\/(\d+(\.\d+)?).*$/, "$1")) : !1, P = !+"\v1",
        M = [0, 0, 0], y = null;
    ...
    return {
        registerObject: function (a, b, c, e) {
            ...
            p.w3 && !(p.wk && 312 > p.wk) && b && c && e && g && h ? (d(c, !1), s(function () {
                ...
                g += "";
                var p = {};
                if (q && typeof q === j) for (var s in q) p[s] = q[s];
                p.data = b;
                p.width = e;
                p.height = g;
                s = {};
                if (n && typeof n === j) for (var u in n) s[u] = n[u];
                if (m && typeof m === j) for (var v in m) s.flashvars = typeof s.flashvars != f ? s.flashvars +
                    ("&" + v + "=" + m[v]) : v + "=" + m[v];
                if (a(h)) u = F(p, s, c), p.id == c && d(c, !0), t.success = !0, t.ref = u; else {
                    if (l && k()) {
                        p.data = l;
                        A(p, s, c, r);
                        return
        ...
        addDomLoadEvent: s, addLoadEvent: m, getQueryParamValue: function (a) {
            ...
            if (b) {
                ...
                for (var b = b.split("&"), c = 0; c < b.length; c++) if (b[c].substring(0, b[c].indexOf("=")) == a) return h(b[c].substring(b[c].indexOf("=") + 1))
            }
            return ""
...
if ("undefined" === typeof ASYouTubeIframeAPIReady) var ASYouTubeIframeAPIReady = !1, ASYouTubeTimeout = 0,
